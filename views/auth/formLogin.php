                        ...
                        <div class="col-sm-12 sign-in-page-data">
                            <div class="sign-in-from bg-primary rounded">
                                ...
                                <?php if (isset($_SESSION['error'])): ?>
                                    <?php 
                                        // Kiểm tra nếu $_SESSION['error'] là mảng
                                    ...
                                    ?>
                                    <p class="text-danger-custom text-center" style="font-size: 15px;"><?= htmlspecialchars($error_message) ?></p>
                                <?php else: ?>
                                    <p class="text-center text-white" style="font-size: 20px;">Vui lòng đăng nhập</p>
                                <?php endif; ?>
                                <form action="index.php?act=check-login" method="POST" class="mt-4 form-text">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input type="email" class="form-control mb-0 text-dark" placeholder="Enter email" name="email" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Password</label>
                                        <a href="#" class="float-right text-dark" style="font-size: 10px;">Quên Mật Khẩu ?</a>
                                        <input type="password" class="form-control mb-0" placeholder="Password" style="color: black;" name="password" required>
                                    </div>
