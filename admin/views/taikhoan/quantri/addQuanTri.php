                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label">Số điện thoại</label>
                                        <input type="so_dien_thoai" class="form-control" name="so_dien_thoai" placeholder="Nhập số điện thoại">
                                ...
                                <div class="form-group">
                                    <label">Mật khẩu</label>
                                        <input type="mat_khau" class="form-control" name="mat_khau" placeholder="Nhập mật khẩu">
