...
class OrderController {
    ...
    public function checkout() {
        ...
        try {
            // Tạo đơn hàng
            $orderId = $this->orderModel->createOrder($totalAmount, 1, $paymentMethodId, 1, $recipientName, $email, $phone, $address, $note);
            ...
            if ($paymentMethodId == 2) { // 2: Thanh toán VNPay
                $this->createVNPayPaymentRequest($orderId, $totalAmount, $recipientName, $email, $phone, $address, $note);
    ...
    public function createVNPayPaymentRequest($orderId, $totalAmount, $recipientName, $email, $phone, $address, $note) {
