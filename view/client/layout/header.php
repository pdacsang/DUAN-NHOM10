...
<!-- Mirrored from bookland.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 07:21:12 GMT -->
<head>
	...
	<link rel="stylesheet" type="text/css" href="client/icons/fontawesome/css/all.min.css">
		...
		<div class="header-info-bar">
			<div class="container clearfix">
				...
				<div class="logo-header logo-dark">
					<a href="index.html"><img src="client/images/logo.png" alt="logo"></a>
				</div>
						...
						<ul class="navbar-nav header-right">
								...
								<ul class="dropdown-menu cart-list">
										...
										<div class="media"> 
											<div class="media-left"> 
												<a href="books-detail.html"> 
													<img alt="" class="media-object" src="client/images/books/small/pic1.jpg"> 
												</a> 
											</div> 
									...
									<li class="cart-item">
										<div class="media"> 
											<div class="media-left"> 
												<a href="books-detail.html"> 
													<img alt="" class="media-object" src="client/images/books/small/pic2.jpg"> 
												</a> 
											</div> 
											<div class="media-body"> 
									...
									<li class="cart-item">
										<div class="media"> 
											<div class="media-left"> 
												<a href="books-detail.html"> 
													<img alt="" class="media-object" src="client/images/books/small/pic3.jpg"> 
												</a> 
											</div> 
											<div class="media-body"> 
							...
							<li class="nav-item dropdown profile-dropdown  ms-4">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<img src="client/images/profile1.jpg" alt="/">
