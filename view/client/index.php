...
<div class="page-content bg-white">
    ...
    <div class="main-slider style-1"> 
        <div class="main-swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide bg-blue" style="background-image: url(client/images/background/waveelement.png);">
                    <div class="container">
                            ...
                            <div class="row">
                                    ...
                                    <div class="swiper-content">
                                        ...
                                        <div class="partner">
                                            ...
                                            <div class="brand-logo">
                                                <img src="client/images/partner/partner-1.png" alt="client">
                                                <img  class="mid-logo" src="client/images/partner/partner-2.png" alt="client">
                                                <img src="client/images/partner/partner-3.png" alt="client">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="banner-media" data-swiper-parallax="-100">
                                        <img src="client/images/banner/banner-media.png" alt="banner-media">
                                    </div>
                                    <img class="pattern" src="client/images/Group.png" data-swiper-parallax="-100" alt="dots">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="banner-content">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="banner-media" data-swiper-parallax="-100">
                                        <img src="client/images/banner/banner-media2.png" alt="banner-media1">
                                    </div>
                                    <img class="pattern" src="client/images/Group.png" data-swiper-parallax="-100" alt="dots">
                                </div>
                            </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="books-card">
                        <div class="dz-media">
                            <img src="client/images/books/book16.png" alt="book">									
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="books-card">
                        <div class="dz-media">
                            <img src="client/images/books/grid/book9.jpg" alt="book">									
                        </div>
                        <div class="dz-content">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book6.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book5.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book2.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book16.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book14.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book1.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-1 wow fadeInUp" data-wow-delay="0.7s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book15.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book11.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book7.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book12.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                                <h5 class="title"><a href="books-grid-view.html">The Missadventure</a></h5>
                                <ul class="dz-tags">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="dz-media">
                                <img src="client/images/books/grid/book3.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="books-card style-2">
                            <div class="dz-media">
                                <img src="client/images/books/large/bigbook1.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                    ...
                    <div class="swiper-slide">
                        <div class="books-card style-2">
                            <div class="dz-media">
                                <img src="client/images/books/large/bigbook2.jpg" alt="book">									
                            </div>
                            <div class="dz-content">
                                <h6 class="sub-title">BEST SELLER</h6>
                                <h2 class="title">A Heavy LIft</h2>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="dz-media">
                                <a href="books-detail.html"><img src="client/images/blog/blog5.jpg" alt="/"></a>
                            </div>
                            <div class="dz-info">
                    ...
                    <div class="swiper-slide">
                        <div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="dz-media">
                                <a href="books-detail.html"><img src="client/images/blog/blog6.jpg" alt="/"></a>
                            </div>
                            <div class="dz-info">
                    ...
                    <div class="swiper-slide">
                        <div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="dz-media">
                                <a href="books-detail.html"><img src="client/images/blog/blog7.jpg" alt="/"></a>
                            </div>
                            <div class="dz-info">
                        ...
                        <div class="testimonial-info">
                            ...
                            <div class="testimonial-detail">
                                <div class="testimonial-pic">
                                    <img src="client/images/testimonial/testimonial1.jpg" alt="">
                                </div>
                        ...
                        <div class="testimonial-info">
                            ...
                            <div class="testimonial-detail">
                                <div class="testimonial-pic radius">
                                    <img src="client/images/testimonial/testimonial2.jpg" alt="">
                                </div>
                                <div>
                ...
                <div class="swiper-slide">
                    <div class="testimonial-1 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="testimonial-info">
                            ...
                            <div class="testimonial-detail">
                                <div class="testimonial-pic radius">
                                    <img src="client/images/testimonial/testimonial3.jpg" alt="">
                                </div>
                                <div>
                ...
                <div class="swiper-slide">
                    <div class="testimonial-1 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="testimonial-info">
                            ...
                            <div class="testimonial-detail">
                                <div class="testimonial-pic radius">
                                    <img src="client/images/testimonial/testimonial4.jpg" alt="">
                                </div>
                                <div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="dz-blog style-1 bg-white m-b30 wow fadeInUp" data-wow-delay="0.1s" >
                            <div class="dz-media">
                                <a href="blog-detail.html"><img src="client/images/blog/grid/blog4.jpg" alt="/"></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="dz-blog style-1 bg-white m-b30 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="dz-media">
                                <a href="blog-detail.html"><img src="client/images/blog/grid/blog3.jpg" alt="/"></a>
                            </div>
                            <div class="dz-info p-3">
                                <h6 class="dz-title">
                    ...
                    <div class="swiper-slide">
                        <div class="dz-blog style-1 bg-white m-b30 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="dz-media">
                                <a href="blog-detail.html"><img src="client/images/blog/grid/blog2.jpg" alt="/"></a>
                            </div>
                            <div class="dz-info p-3">
                                <h6 class="dz-title">
                                    <a href="blog-detail.html">Benefits of reading: Smart, Diligent, Happy, Intelligent</a>
                    ...
                    <div class="swiper-slide">
                        <div class="dz-blog style-1 bg-white m-b30 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="dz-media">
                                <a href="blog-detail.html"><img src="client/images/blog/grid/blog1.jpg" alt="/"></a>
                            </div>
                            <div class="dz-info p-3">
                                <h6 class="dz-title">
    ...
    <!-- Newsletter -->
    <section class="py-5 newsletter-wrapper" style="background-image: url('client/images/background/bg1.jpg'); background-size: cover;">
        <div class="container">
