        ...
        <section class="row">
            <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                <div class="bestselling__product-img-box">
                    <img src="./assets/images1/product/image_195509_1_22250_thanh_ly_1.jpg" alt="Biểu tượng thất truyền" class="bestselling__product-img">
                </div>
            ...
            <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                <div class="bestselling__product-img-box">
                    <img src="./assets/images1/product/image_195509_1_31875.jpg" alt="Hỏa Ngục (Tái bản 2020)" class="bestselling__product-img">
                </div>
                <div class="bestselling__product-text">
                    <h3 class="bestselling__product-title">
            ...
            <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                <div class="bestselling__product-img-box">
                    <img src="./assets/images1/product/tr_-tue-do-thai_outline_15.9.2017-02.jpg" alt="Trí Tuệ Do Thái (Tái Bản 2018)" class="bestselling__product-img">
                </div>
                <div class="bestselling__product-text">
                    <h3 class="bestselling__product-title">
            ...
            <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                <div class="bestselling__product-img-box">
                    <img src="./assets/images1/product/image_195509_1_36793.jpg" alt="Nhà Giả Kim (Tái Bản 2020)" class="bestselling__product-img">
                </div>
                <div class="bestselling__product-text">
                    <h3 class="bestselling__product-title">
            ...
            <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                <div class="bestselling__product-img-box">
                    <img src="./assets/images1/product/image_180164_2_287.jpg" alt="Tuổi Trẻ Đáng Giá Bao Nhiêu? " class="bestselling__product-img">
                </div>
                <div class="bestselling__product-text">
                    <h3 class="bestselling__product-title">
            ...
            <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                <div class="bestselling__product-img-box">
                    <img src="./assets/images1/product/ttdc01.jpg" alt="Thám Tử Đã Chết - Tập 1 - Tặng Kèm Bookmark Tròn" class="bestselling__product-img">
                </div>
                <div class="bestselling__product-text">
                    <h3 class="bestselling__product-title">
                ...
                <nav class="product__sidebar-list">
                    ...
                    <div class="row">
                        <div class="product__sidebar-item col-lg-6">
                            <img src="./assets/images1/product/【グラブル】「炭治郎&禰豆子&善逸&伊之助」の評価_性能検証｜鬼滅コラボ【グランブルーファンタジー】 - ゲームウィズ(GameWith).jfif" alt="" class="product__sidebar-item-img">
                            <a href="" class="product__sidebar-item-name">Manga</a>
                        </div>
                        <div class="product__sidebar-item col-lg-6">
                            <img src="./assets/images1/product/My Anime For Life.jfif" class="product__sidebar-item-img">
                        ...
                        <div class="product__sidebar-item col-lg-6">
                            <img src="./assets/images1/product/8936054081882.jpg" alt="" class="product__sidebar-item-img">
            ...
            <article class="product__content col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="row product__panel">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/600my-hero-academia-hoc-vien-sieu-anh-hung.jpg" alt="" class="product__panel-img">
                            </div>
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/cau-ma-nha-xi-hanako---tap-1.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/one-piece-tap-95_chuyen-chu-du-cua-oden_1.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/mob-psycho-100_tap-3.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/thanh-guom-diet-quy-tap-12.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/image_186914.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/image_186912.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                    ...
                    <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                        <div class="product__panel-item-wrap">
                            <div class="product__panel-img-wrap">
                                <img src="./assets/images1/product/one-22.jpg" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
    ...
    <div class="container">
        ...
        <div class="row bg-white">
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="./assets/images1/product/image_187163.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
            ...
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="./assets/images1/product/image_188285.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
            ...
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="./assets/images1/product/8936186542176.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
            ...
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="./assets/images1/product/biamem.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
            ...
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="./assets/images1/product//8936049524905.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
            ...
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="./assets/images1/product/bia1_tobinhyen_2_1_1.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
